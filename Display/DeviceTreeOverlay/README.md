For my device tree overlay, I decided to use <b>Mode 6</b> of the DPI Output Format. Using mode 6 allows me to have 6 bits red, 6 bits green and 6 bits blue.</br>
